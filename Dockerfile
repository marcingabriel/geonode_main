...
RUN mkdir -p /usr/src/geonode_main
...
COPY src /usr/src/geonode_main/
WORKDIR /usr/src/geonode_main
...
RUN chmod +x /usr/src/geonode_main/tasks.py \
    && chmod +x /usr/src/geonode_main/entrypoint.sh
...
# ENTRYPOINT /usr/src/geonode_main/entrypoint.sh
